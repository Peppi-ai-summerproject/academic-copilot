...
class AcademicRiskScoringService:
    ...
    def __init__(
        ...
        tutor_meeting_risk_service: TutorMeetingEvaluator | None = None,
    ) -> None:
    ...
    def assess_student_risk(
        ...
        *,
        ...
        try:
            tutor_result = (
                self._tutor_meeting_risk_service.evaluate_student(
                    student_id, as_of_date=as_of_date
                )
                if self._tutor_meeting_risk_service is not None
                else None
            )
        except Exception:
            tutor_result = {
