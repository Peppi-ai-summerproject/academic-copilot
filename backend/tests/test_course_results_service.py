...
def _service(rows):
    ...
    courses.get_by_code.return_value = {"id": 9, "course_code": "DIN24"}
...
def test_course_results_preserve_no_result_and_filter():
    ...
    assert _service(rows).course_results("DIN24", "FAILED")["results"] == [rows[1]]
